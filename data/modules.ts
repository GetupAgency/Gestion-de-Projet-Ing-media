export type QuestionType = 'mcq' | 'true-false' | 'fill-blank' | 'scenario'
export type DifficultyLevel = 'facile' | 'moyen' | 'difficile'
export type QuizCategory = 'gestion-projet' | 'technique' | 'methodologie' | 'budget' | 'design-ux' | 'test-qualite' | 'lexique'
...
**Question** : Quels sont les premiers éléments à clarifier avec le client ?`,
  ...
  <h2 class="correction-title">Éléments à clarifier avec le client</h2>

  <h3 class="correction-subtitle">1. Objectifs et vision</h3>
  <ul class="correction-list">
    <li><strong>Pourquoi cette refonte ?</strong> Baisse de trafic, image vieillissante, problèmes techniques, nouvelles fonctionnalités souhaitées ?</li>
    <li><strong>Quels sont les objectifs business ?</strong> Augmenter les ventes de X%, améliorer le taux de conversion, toucher une nouvelle cible ?</li>
    <li><strong>Quelle est la vision à 2-3 ans ?</strong> Expansion internationale, nouvelles gammes, marketplace ?</li>
  </ul>

  <h3 class="correction-subtitle">2. Existant technique et contenu</h3>
  <ul class="correction-list">
    <li><strong>Quelle est la plateforme actuelle ?</strong> (Prestashop, WooCommerce, développement custom…)</li>
    <li><strong>Combien de produits en catalogue ?</strong> (Impact direct sur la migration et la complexité)</li>
    <li><strong>Base clients existante ?</strong> Historique des commandes, comptes clients à migrer ?</li>
    <li><strong>Contenu à conserver ?</strong> Fiches produits, photos, descriptions, avis clients</li>
    <li><strong>Données SEO à préserver ?</strong> Positionnement Google, backlinks, URLs indexées</li>
  </ul>

  <h3 class="correction-subtitle">3. Expérience utilisateur mobile</h3>
  <ul class="correction-list">
    <li><strong>Part du trafic mobile actuel ?</strong> (Si > 50%, approche mobile-first indispensable)</li>
    <li><strong>Parcours d'achat mobile :</strong> Faut-il repenser complètement le tunnel de conversion ?</li>
    <li><strong>Paiement mobile :</strong> Apple Pay, Google Pay, paiement en 1 clic ?</li>
  </ul>

  <h3 class="correction-subtitle">4. Système de paiement</h3>
  <ul class="correction-list">
    <li><strong>PSP actuel ?</strong> (Stripe, PayPal, Payplug, solution bancaire…)</li>
    <li><strong>Moyens de paiement souhaités :</strong> CB, PayPal, virement, paiement fractionné (Alma, Klarna) ?</li>
    <li><strong>Contraintes réglementaires :</strong> DSP2, 3D Secure, facturation automatique ?</li>
  </ul>

  <h3 class="correction-subtitle">5. Contraintes du projet</h3>
  <ul class="correction-list">
    <li><strong>Budget de 25 000€ :</strong> Est-ce ferme ou négociable ? Inclut-il la maintenance post-livraison ?</li>
    <li><strong>Délai de 4 mois :</strong> Y a-t-il un événement clé (saison haute, lancement produit) ?</li>
    <li><strong>Équipe côté client :</strong> Qui sera l'interlocuteur principal ? Disponibilité pour les validations ?</li>
    <li><strong>Hébergement :</strong> Souhaite-t-il rester chez l'hébergeur actuel ou migrer ?</li>
  </ul>

  <div class="example-box">
    <strong>Point clé :</strong> Ces questions permettent de transformer un brief vague en cahier des charges précis. Un projet bien cadré dès le départ, c'est 80% de chances de succès en plus.
  </div>
</div>`
        },
        quiz: [
  ...
  <div class="warning-box">
    <p class="warning-title">Attention : Le CDC mal défini, ennemi n°1 des projets</p>
...
<p class="section-text"><strong>Ce qu'il faut retenir :</strong> sans CDC, l'écart de prix ne vient pas des agences mais des <em>hypothèses</em> que chacune a dû inventer à la place du client.</p>
  ...
  <div class="comparison-grid">
    <div class="comparison-before">
      <h4>Site e-commerce non audité</h4>
      <ul>
        <li>Temps de chargement : 8 secondes</li>
        <li>Taux de rebond : 75%</li>
        <li>Score Lighthouse : 25/100</li>
        <li>Mobile : non optimisé</li>
        <li>SEO : page 5 de Google</li>
      </ul>
    </div>
    <div class="comparison-after">
      <h4>Après audit et refonte</h4>
      <ul>
        <li>Temps de chargement : 1,5 seconde</li>
        <li>Taux de rebond : 35%</li>
        <li>Score Lighthouse : 95/100</li>
        <li>Mobile-first responsive</li>
        <li>SEO : page 1 de Google</li>
      </ul>
    </div>
  </div>
</div>`,
  ...
  <div class="example-box">
    ...
    • Score Lighthouse : > 90/100
      ...
      },
      {
        ...
        content: `<div class="section-content">
  <h1 class="section-title">Étude des cibles</h1>

  <p class="section-text">Connaître ses utilisateurs est essentiel pour concevoir un projet web adapté à leurs besoins.</p>

  <div class="story-box">
    <p class="story-title">Histoire vraie : Quand on oublie les utilisateurs</p>
    <p>En 2010, Google lance <strong>Google Wave</strong>, un outil révolutionnaire de communication en temps réel. L'équipe a investi 2 ans de développement avec les meilleurs ingénieurs du monde. Problème : personne n'a demandé aux utilisateurs s'ils en avaient besoin. Résultat : <strong>le produit est abandonné en moins d'un an</strong>. La leçon ? Un produit techniquement parfait mais qui ne répond pas aux besoins réels des utilisateurs est voué à l'échec.</p>
  </div>

  <h2 class="section-subtitle mt-8">Pourquoi étudier les cibles ?</h2>

  <div class="value-type">
    <ul class="feature-list">
      <li>Adapter le design et l'ergonomie</li>
      <li>Prioriser les fonctionnalités</li>
      <li>Choisir le bon ton de communication</li>
      <li>Optimiser le parcours utilisateur</li>
    </ul>
  </div>

  <h2 class="section-subtitle mt-8">Méthodes d'étude</h2>

  <div class="deliverables-grid">
    <div class="deliverable-phase">
      <h4 class="phase-title">1. Personas</h4>
      <p class="project-detail">Créer des profils types d'utilisateurs avec :</p>
      <ul class="deliverable-list">
        <li>Données démographiques</li>
        <li>Objectifs et motivations</li>
        <li>Freins et frustrations</li>
        <li>Comportements numériques</li>
      </ul>
    </div>

    <div class="deliverable-phase">
      <h4 class="phase-title">2. User stories</h4>
      <p class="project-detail">"En tant que [type d'utilisateur], je veux [objectif] afin de [bénéfice]"</p>
      <div class="example-box">
        <strong>Exemple :</strong> "En tant que client, je veux filtrer les produits par prix afin de trouver rapidement ce qui correspond à mon budget"
      </div>
    </div>

    <div class="deliverable-phase">
      <h4 class="phase-title">3. Carte d'empathie</h4>
      <ul class="deliverable-list">
        <li>Ce que l'utilisateur <strong>pense et ressent</strong></li>
        <li>Ce qu'il <strong>voit</strong></li>
        <li>Ce qu'il <strong>dit et fait</strong></li>
        <li>Ce qu'il <strong>entend</strong></li>
      </ul>
    </div>

    <div class="deliverable-phase">
      <h4 class="phase-title">4. Enquêtes et interviews</h4>
      <ul class="deliverable-list">
        <li>Questionnaires en ligne</li>
...
5. Appareils utilisés (desktop, mobile, tablette)`,
          correction: `<div class="correction-content">
  <h2 class="correction-title">Persona 1 : L'étudiant en reconversion</h2>

  <div class="project-type">
    <h3 class="project-type-title">Marie Dupont, 32 ans</h3>
    <div class="project-detail">
      <strong>Profession actuelle :</strong> Ex-responsable marketing digital, en reconversion vers le développement web
    </div>
    <div class="project-detail">
      <strong>Situation :</strong> En formation intensive depuis 3 mois, utilise ses économies et ses droits CPF
    </div>
  </div>

  <div class="value-type">
    <h3 class="value-title">Objectifs principaux</h3>
    <ul class="correction-list">
      <li><strong>Acquérir des compétences techniques solides</strong> pour décrocher un premier poste de développeuse junior</li>
      <li><strong>Construire un portfolio de projets</strong> concrets à montrer en entretien</li>
      <li><strong>Comprendre l'écosystème tech</strong> : frameworks, outils, méthodologies de travail</li>
      <li><strong>Rejoindre une communauté</strong> de développeurs pour du mentorat et du networking</li>
    </ul>
  </div>

  <div class="value-type">
    <h3 class="value-title">Freins et frustrations</h3>
    <ul class="correction-list">
      <li><strong>Syndrome de l'imposteur :</strong> Se sent en retard par rapport aux développeurs diplômés</li>
      <li><strong>Surcharge d'informations :</strong> Trop de ressources en ligne, ne sait pas par où commencer</li>
      <li><strong>Budget limité :</strong> Ne peut pas se permettre des formations à 2000€/mois</li>
      <li><strong>Manque de pratique :</strong> Comprend la théorie mais bloque sur les projets concrets</li>
      <li><strong>Peur de ne pas trouver d'emploi :</strong> Inquiète sur le marché de l'emploi pour les reconvertis</li>
    </ul>
  </div>

  <div class="value-type">
    <h3 class="value-title">Niveau technique</h3>
    <ul class="correction-list">
      <li><strong>HTML/CSS :</strong> Intermédiaire (à l'aise avec les bases, découvre Flexbox/Grid)</li>
      <li><strong>JavaScript :</strong> Débutant (comprend les variables, boucles, fonctions)</li>
      <li><strong>Framework :</strong> Aucune expérience, veut apprendre React</li>
      <li><strong>Outils :</strong> Utilise VS Code, connaît GitHub basique</li>
    </ul>
  </div>

  <div class="project-detail">
    <strong>Appareils :</strong> Laptop personnel (MacBook Air), smartphone pour les vidéos dans les transports
  </div>

  <hr class="my-8 border-gray-300">

  <h2 class="correction-title">Persona 2 : Le développeur senior</h2>

  <div class="project-type">
    <h3 class="project-type-title">Thomas Martin, 38 ans</h3>
    <div class="project-detail">
      <strong>Profession :</strong> Lead développeur back-end chez un éditeur de logiciels, 12 ans d'expérience
    </div>
    <div class="project-detail">
      <strong>Situation :</strong> Expertise PHP/Symfony, souhaite évoluer vers le full-stack et le management technique
    </div>
  </div>
  ...
  <div class="value-type">
    <h3 class="value-title">Objectifs principaux</h3>
    <ul class="correction-list">
      <li><strong>Maîtriser les technologies front modernes</strong> (React, TypeScript, Next.js)</li>
      <li><strong>Développer des compétences de tech lead :</strong> architecture, code review, mentorat</li>
      <li><strong>Rester à jour</strong> sur les nouvelles pratiques (serverless, CI/CD avancé, testing)</li>
      <li><strong>Préparer une évolution vers CTO</strong> en comprenant l'ensemble de la stack</li>
    </ul>
  </div>
  ...
  <div class="value-type">
    <h3 class="value-title">Freins et frustrations</h3>
    <ul class="correction-list">
      <li><strong>Manque de temps :</strong> Travaille 45h/semaine, famille avec 2 enfants</li>
      <li><strong>Contenus trop basiques :</strong> 90% des formations sont pour débutants, perte de temps</li>
      <li><strong>Formats inadaptés :</strong> Préfère des exercices pratiques avancés, pas des tutoriels vidéo de 40 min</li>
      <li><strong>ROI incertain :</strong> Hésite à investir dans une formation vs apprendre en autodidacte</li>
    </ul>
  </div>
  ...
  <div class="value-type">
    <h3 class="value-title">Niveau technique</h3>
    <ul class="correction-list">
      <li><strong>Back-end :</strong> Expert (PHP, Symfony, API REST, SQL avancé)</li>
      <li><strong>Front-end :</strong> Intermédiaire (jQuery, un peu de Vue.js)</li>
      <li><strong>DevOps :</strong> Bon niveau (Docker, CI/CD, AWS basique)</li>
      <li><strong>Architecture :</strong> Solide (microservices, design patterns, SOLID)</li>
    </ul>
  </div>

  <div class="project-detail">
    <strong>Appareils :</strong> Desktop professionnel (Linux), MacBook Pro personnel, iPad pour la lecture
  </div>

  <hr class="my-8 border-gray-300">

  <div class="example-box">
    <strong>Impact sur la conception :</strong><br>
    • <strong>Marie</strong> a besoin de parcours guidés, de projets pas à pas, et de prix accessibles<br>
    • <strong>Thomas</strong> a besoin de contenus avancés, de formats courts, et d'exercices de niveau expert<br>
    • La plateforme doit proposer des <strong>niveaux de difficulté</strong> et des <strong>parcours personnalisés</strong>
  </div>
</div>`
        }
      }
