...
const annexes = [
  ...
  { href: '/entrainement', title: 'Terrain d’entraînement', detail: 'Dix ateliers en groupe de 30 min à 1 h (brief SMART, note d’intention, crises, scope creep, dire non, devis, kick-off, jalons) et treize exercices en solo.' },
