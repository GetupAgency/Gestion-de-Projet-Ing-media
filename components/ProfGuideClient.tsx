...
export default function ProfGuideClient() {
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-4">
        ...
        >
          <div className="prose prose-sm max-w-none">
            <div className="bg-copy-yellow border-l-4 border-yellow-600 p-4  mb-4">
            ...
            <h4 className="font-semibold text-ink mb-2">Exemple de réponse attendue :</h4>
            <div className="bg-paper-2 p-4  border-l-4 border-purple-600">
            ...
            <h4 className="font-semibold text-ink mt-6 mb-2">Composition de l'équipe projet :</h4>
            <div className="bg-paper-2 p-4 ">
              <div className="space-y-3 text-sm">
                <div>
                  <p className="font-semibold">Marie Dubois - Chef de Projet Senior</p>
                  <p className="text-ink-2">12 ans d'expérience en gestion de projets SaaS, certifiée Scrum Master et Product Owner. Allocation : 50% sur 8 mois.</p>
                </div>
                <div>
                  <p className="font-semibold">Thomas Chen - Lead Developer Backend</p>
                  <p className="text-ink-2">9 ans Node.js/Python, expert architecture microservices et APIs REST. Spécialiste scalabilité. Allocation : 80%.</p>
                </div>
                <div>
                  <p className="font-semibold">Sophie Martin - Developer Frontend/Mobile</p>
                  <p className="text-ink-2">6 ans React/React Native, expérience apps événementielles (Festival App 2023). Allocation : 80%.</p>
                </div>
                <div>
                  <p className="font-semibold">Alexandre Rousseau - UX/UI Designer</p>
                  <p className="text-ink-2">8 ans design produit, expert Figma, portfolio applications mobiles grand public. Allocation : 40%.</p>
                </div>
                <div>
                  <p className="font-semibold">Lucas Bernard - DevOps</p>
                  <p className="text-ink-2">5 ans AWS, expert CI/CD et monitoring. Allocation : 25%.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        >
          <div className="prose prose-sm max-w-none">
            ...
            <h4 className="font-semibold text-ink mb-2">Notre compréhension du projet :</h4>
            <div className="bg-paper-2 p-4  mb-4">
              <p className="mb-3">
            ...
            <h4 className="font-semibold text-ink mb-2">20 Questions complémentaires à poser :</h4>
            <div className="bg-paper-2 p-4 ">
        ...
        >
          <div className="prose prose-sm max-w-none">
            ...
            <h4 className="font-semibold text-ink mb-2">Écrans prioritaires (15 minimum) :</h4>
            <div className="bg-paper-2 p-4  mb-4">
            ...
            <h4 className="font-semibold text-ink mb-2">Parcours clé à détailler :</h4>
            <div className="bg-paper-2 p-4  text-sm">
        ...
        >
          <div className="prose prose-sm max-w-none">
            ...
            <h4 className="font-semibold text-ink mb-2">Stack recommandée :</h4>
            <div className="bg-paper-2 p-4  mb-4">
              <div className="space-y-3 text-sm">
                <div>
            ...
            <h4 className="font-semibold text-ink mb-2">Schéma d'architecture :</h4>
            <div className="bg-paper-2 p-4  text-sm">
...
└─────────────┘`}
        ...
        >
          <div className="prose prose-sm max-w-none">
            ...
            <h4 className="font-semibold text-ink mb-2">Découpage en phases (7 mois) :</h4>
            <div className="bg-paper-2 p-4 ">
              <div className="space-y-4 text-sm">
                <div className="border-l-4 border-purple-600 pl-3">
                  <p className="font-semibold">MOIS 1 - Cadrage et Discovery</p>
                  <p className="text-ink-2 mb-1">Durée : 4 semaines</p>
                  ...
                  <p className="text-ink-2 text-xs mt-2">Livrable : Document de cadrage validé (30 pages)</p>
                </div>

                <div className="border border-ink pl-3">
                  ...
                  <p className="text-ink-2 text-xs mt-2">Livrable : Design system + Maquettes validées</p>
                </div>

                <div className="border border-stamp pl-3">
                  <p className="font-semibold">MOIS 3-6 - Développement (16 semaines / 8 sprints)</p>
                  <p className="text-ink-2 mb-1">Sprints de 2 semaines</p>
                  
                  <div className="ml-4 mt-2 space-y-2">
                    <div>
                      <p className="font-medium">Sprint 1-2 (Mois 3) : Fondations</p>
                      <p className="text-ink-2">Architecture backend, authentification, BDD, setup infra AWS</p>
                    </div>
                    <div>
                      <p className="font-medium">Sprint 3-4 (Mois 4) : Core Features Organisateur</p>
                      <p className="text-ink-2">Création événement, gestion agenda, billetterie basique</p>
                    </div>
                    <div>
                      <p className="font-medium">Sprint 5-6 (Mois 5) : App Mobile Base</p>
                      <p className="text-ink-2">Login, feed événement, profil, QR scan</p>
                    </div>
                    <div>
                      <p className="font-medium">Sprint 7-8 (Mois 6) : Networking & Temps Réel</p>
                      <p className="text-ink-2">Matching algorithme, messagerie, Socket.io, notifications push</p>
                    </div>
                  </div>
                  <p className="text-ink-2 text-xs mt-2">Livrable : MVP fonctionnel complet</p>
                </div>

                <div className="border-l-4 border-orange-600 pl-3">
                  <p className="font-semibold">MOIS 7 - Tests et Recette</p>
                  <p className="text-ink-2 mb-1">Durée : 3 semaines</p>
                  <ul className="list-disc pl-5 text-ink-2">
                ...
                <div className="border-l-4 border-red-600 pl-3">
                  ...
                  <p className="text-ink-2 mb-1">Durée : 1 semaine</p>
                  <ul className="list-disc pl-5 text-ink-2">
        ...
        >
          <div className="prose prose-sm max-w-none">
            ...
            <div className="bg-paper-2 p-4 ">
              <h4 className="font-semibold text-ink mb-3">Budget Total : 105 000€</h4>
              ...
              <table className="w-full text-sm">
                ...
                <tbody className="divide-y">
                  ...
                  <tr className="bg-purple-100">
                    ...
                    <td className="text-right p-2 font-bold text-ink text-lg">104 120€</td>
                  </tr>
                </tbody>
              </table>

              <div className="mt-4 p-3 bg-paper-2  text-xs">
        ...
        >
          <div className="prose prose-sm max-w-none">
            <div className="bg-paper-2 border border-ink p-4  mb-4">
            ...
            <h4 className="font-semibold text-ink mb-2">Exemples d'Objectifs SMART pour Eventeo :</h4>
            <div className="bg-paper-2 p-4  space-y-4">
              <div className="border border-stamp pl-3 py-2">
                <p className="font-semibold text-ink mb-2">Objectif 1 : Adoption de l'App Mobile</p>
              ...
              <div className="border border-ink pl-3 py-2">
                <p className="font-semibold text-ink mb-2">Objectif 2 : Performance Technique</p>
                <p className="text-sm text-ink-2 mb-2">
              ...
              <div className="border-l-4 border-purple-600 pl-3 py-2">
                <p className="font-semibold text-ink mb-2">Objectif 3 : Satisfaction Client</p>
                <p className="text-sm text-ink-2 mb-2">
              ...
              <div className="border-l-4 border-orange-600 pl-3 py-2">
                <p className="font-semibold text-ink mb-2">Objectif 4 : Networking Efficace</p>
                <p className="text-sm text-ink-2 mb-2">
              ...
              <div className="border-l-4 border-pink-600 pl-3 py-2">
                <p className="font-semibold text-ink mb-2">Objectif 5 : Livraison MVP</p>
                <p className="text-sm text-ink-2 mb-2">
            ...
            <div className="bg-stamp-soft border border-stamp p-4  mt-4">
        ...
        >
          <div className="prose prose-sm max-w-none">
            ...
            <h4 className="font-semibold text-ink mb-2">Modèle de Revenus Recommandé :</h4>
            <div className="bg-paper-2 p-4  mb-4">
              <div className="space-y-4 text-sm">
                <div>
                  <p className="font-semibold text-ink mb-1">Option 1 : Commission sur Billetterie (Recommandé)</p>
                ...
                <div>
                  <p className="font-semibold text-ink mb-1">Option 2 : Abonnement Organisateur</p>
                  <p className="text-ink-2 mb-2">
                ...
                <div>
                  <p className="font-semibold text-ink mb-1">Option 3 : Mixte (Plus Robuste)</p>
                  <p className="text-ink-2">
            ...
            <h4 className="font-semibold text-ink mb-2">Coûts Récurrents (Opex) :</h4>
            <div className="bg-paper-2 p-4  mb-4">
              <table className="w-full text-sm">
                <tbody className="divide-y">
                  <tr>
                  ...
                  <tr className="bg-paper-2 font-bold">
                    ...
                    <td className="text-right py-2 text-ink">7 500-11 000€/mois</td>
                  </tr>
                </tbody>
              </table>
            ...
            <h4 className="font-semibold text-ink mb-2">Stratégie Go-to-Market :</h4>
            <div className="bg-paper-2 p-4  mb-4 text-sm">
              <div className="space-y-3">
                <div>
                  <p className="font-semibold text-ink">Phase 1 : Validation (Mois 1-3)</p>
                  <p className="text-ink-2">
                ...
                <div>
                  <p className="font-semibold text-ink">Phase 2 : Croissance Initiale (Mois 4-12)</p>
                  <p className="text-ink-2">
                ...
                <div>
                  <p className="font-semibold text-ink">Phase 3 : Scale (Mois 12-24)</p>
                  <p className="text-ink-2">
            ...
            <h4 className="font-semibold text-ink mb-2">Features vs Business Model :</h4>
            <div className="bg-paper-2 p-4  text-sm">
              <table className="w-full">
                ...
                <tbody className="divide-y">
                  <tr>
                    ...
                    <td className="text-center p-2">✓</td>
                    <td className="p-2 text-ink-2">Acquisition</td>
                  </tr>
                  <tr>
                    <td className="p-2">Billetterie basique</td>
                    <td className="text-center p-2">✓</td>
                    <td className="text-center p-2">✓</td>
                    <td className="p-2 text-ink-2">Hook principal</td>
                  </tr>
                  <tr>
                    <td className="p-2">App mobile participants</td>
                    <td className="text-center p-2">✓</td>
                    <td className="text-center p-2">✓</td>
                    <td className="p-2 text-ink-2">Différenciation</td>
                  </tr>
                  <tr>
                    <td className="p-2">Analytics avancés</td>
                    <td className="text-center p-2">-</td>
                    <td className="text-center p-2">✓</td>
                    <td className="p-2 text-ink font-semibold">Monétisation</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td className="text-center p-2">-</td>
                    <td className="text-center p-2">✓</td>
                    <td className="p-2 text-ink font-semibold">Rétention</td>
                  </tr>
                  <tr>
                    <td className="p-2">API ouverte</td>
                    <td className="text-center p-2">-</td>
                    <td className="text-center p-2">✓</td>
                    <td className="p-2 text-ink font-semibold">Lock-in</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            <div className="bg-copy-yellow border-l-4 border-orange-600 p-4  mt-4">
            ...
            <h4 className="font-semibold text-ink mb-2">Projection Financière Simplifiée (à partager) :</h4>
            <div className="bg-paper-2 p-4 ">
              <table className="w-full text-sm">
                <thead className="bg-gray-200">
                  <tr>
                ...
                <tbody className="divide-y">
                  ...
                  <tr className="bg-paper-2 font-bold">
                    ...
                    <td className="text-right p-2 text-ink">Rentable mois 6-7</td>
                  </tr>
                </tbody>
              </table>
              <p className="text-xs text-ink-2 mt-3">
          ...
          <div className="prose prose-sm max-w-none">
            ...
            <div className="space-y-4">
              {[
                ...
                <div key={i} className="bg-paper-2 p-4  border-l-4 border-orange-500">
                  <div className="flex items-start justify-between mb-2">
                    <p className="font-semibold text-ink">{r.risque}</p>
                  ...
                  <p className="text-sm text-ink-2"><strong>Mitigation :</strong> {r.mitigation}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        >
          <div className="prose prose-sm max-w-none">
            <h4 className="font-semibold text-ink mb-3">Activités pour débloquer ou faire souffler</h4>
            
            <div className="space-y-6">
              {/* Exercice Architecture */}
              <div className="bg-paper-2 border-2 border-blue-300 p-4 ">
              ...
              {/* Exercice Budget */}
              <div className="bg-stamp-soft border-2 border-green-300 p-4 ">
              ...
              {/* Pause Créative */}
              <div className="bg-paper-2 border-2 border-purple-300 p-4 ">
                <h5 className="font-bold text-ink mb-2">Pause 3 : Jeu des Personas (5 min)</h5>
              ...
              <div className="bg-copy-yellow border-2 border-orange-300 p-4 ">
              ...
              {/* Brainstorm Risques */}
              <div className="bg-red-soft border-2 border-red-300 p-4 ">
              ...
              {/* Jeu Priorités */}
              <div className="bg-copy-pink border-2 border-pink-300 p-4 ">
              ...
              {/* Échange Équipes */}
              <div className="bg-paper-2 border-2 border-cyan-300 p-4 ">
              ...
              {/* Pitch Express */}
              <div className="bg-copy-yellow border-2 border-yellow-300 p-4 ">
              ...
              {/* Calcul Mental */}
              <div className="bg-paper-2 border-2 border-indigo-300 p-4 ">
              ...
              {/* User Stories */}
              <div className="bg-paper-2 border-2 border-teal-300 p-4 ">
          ...
          <div className="prose prose-sm max-w-none">
            <div className="space-y-4">
              <div className="bg-paper-2 p-4 ">
                ...
                <div className="space-y-3 text-sm">
                  <div>
                    <p className="font-medium text-ink">Le chiffrage :</p>
                    <p className="text-ink-2">Guidez-les : "Listez toutes les features. Pour chaque feature, estimez combien de jours de dev. Exemple : Login = 2j, Dashboard = 5j, etc. Total × TJM moyen."</p>
                  </div>
                  
                  <div>
                    <p className="font-medium text-ink">L'architecture :</p>
                    <p className="text-ink-2">Rappelez les 3 couches : Frontend (ce que l'utilisateur voit), Backend/API (logique métier), BDD (stockage). Ajoutez infra (serveurs) et services tiers (paiement, email).</p>
                  </div>
                  
                  <div>
                    <p className="font-medium text-ink">Les wireframes :</p>
                    <p className="text-ink-2">Commencez papier ! Dessinez les 5 écrans principaux au crayon. Ensuite Figma. L'important n'est pas la beauté mais la logique du parcours.</p>
                  </div>
                  
                  <div>
                    <p className="font-medium text-ink">Le planning :</p>
                    <p className="text-ink-2">Méthode simple : Total jours estimés ÷ nombre de devs = durée. Ajoutez 20% de marge. Découpez en phases logiques : Design → Dev → Tests.</p>
                  </div>
                </div>
              </div>

              <div className="bg-stamp-soft p-4 ">
...
function CorrectionSection({ 
  ...
  return (
    <div className="bg-white  border border-ink overflow-hidden">
      <button
        onClick={onToggle}
        className="w-full px-6 py-4 flex items-center justify-between hover:bg-paper-2 transition-colors"
      >
